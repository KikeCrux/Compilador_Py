...
def verificar_tipo(nodo):
    if isinstance(nodo, tuple):
        ...
        # Si es una asignación
            ...
            return ('assign', f"var.{tipo_var}", var, exp)
        ...
        # Si es una operación aritmética
            ...
            return (nodo[0], f"var.{tipo_izq[1]}", tipo_izq, tipo_der)
        ...
        # Si es una condición if-else
            ...
            return ('if_else', f"var.{condicion[1]}", bloque_then, bloque_else)
        ...
        # Si es un ciclo while
            ...
            return ('while', f"var.{condicion[1]}", cuerpo)
        ...
        # Si es un ciclo do-while, ajustamos el formato para mostrar más ordenadamente
            ...
            return ('do_until', 'bloque', cuerpo, f"var.{condicion[1]}", condicion)
        ...
        # Si es una operación lógica
            ...
            return (nodo[0], 'var.bool', tipo_izq, tipo_der)
    ...
    # Si es un literal booleano (true o false)
        ...
        return ('literal', 'var.bool', nodo)  # Usar var.bool

    # Si es un número
    elif isinstance(nodo, (int, float)):
        tipo = 'int' if isinstance(nodo, int) else 'float'
        return ('numero', f"var.{tipo}", nodo)  # Usar var.int o var.float
    ...
    # Si es un identificador (variable)
        ...
        return ('var', f"var.{tipo}", f"{nodo}.{tipo}")  # Usar var.tipo
